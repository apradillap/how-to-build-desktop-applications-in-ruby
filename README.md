...
- [How To Build Desktop Applications in Ruby](#how-to-build-desktop-applications-in-ruby)
  ...
  * [Setup Workshop GitHub Repository](#setup-workshop-github-repository)
  * [Resources](#resources)
  * [Exercises](#exercises)
    + [Section 1 GUI Basics](#section-1-gui-basics)
      - [Exercise 1 Empty Window](#exercise-1-empty-window)
      - [Exercise 2 Hello, World! Window with Args](#exercise-2-hello-world-window-with-args)
      - [Exercise 3 Hello, World! Window with Props](#exercise-3-hello-world-window-with-props)
      - [Exercise 4 Hello, World! Window + Label with Args](#exercise-4-hello-world-window--label-with-args)
      - [Exercise 5 Hello, World! Window + Label with Props](#exercise-5-hello-world-window--label-with-props)
      - [Exercise 6 Hello, Button!](#exercise-6-hello-button)
      - [Exercise 7 Hello, Layout! with Horizontal Box](#exercise-7-hello-layout-with-horizontal-box)
      - [Exercise 8 Hello, Layout! with Horizontal & Vertical Boxes](#exercise-8-hello-layout-with-horizontal--vertical-boxes)
      - [Exercise 9 Option Selector](#exercise-9-option-selector)
    + [Section 2 MVC Software Architecture](#section-2-mvc-software-architecture)
      - [Exercise 10 Option Selector MVC Explicit Controller](#exercise-10-option-selector-mvc-explicit-controller)
      - [Exercise 11 Option Selector MVC Implicit Controller](#exercise-11-option-selector-mvc-implicit-controller)
    + [Section 3 MVP & Data-Binding](#section-3-mvp--data-binding)
      - [Exercise 12 Option Selector MVP and Data-Binding](#exercise-12-option-selector-mvp-and-data-binding)
      - [Exercise 13 Option Selector with Reset](#exercise-13-option-selector-with-reset)
      - [Exercise 14 Address Form](#exercise-14-address-form)
      - [Exercise 14b Form Table](#exercise-14b-form-table)
      - [Exercise 15 Dynamic Form](#exercise-15-dynamic-form)
      - [Exercise 16 Dynamic Address Forms](#exercise-16-dynamic-address-forms)
    + [Section 4 Advanced Data-Binding](#section-4-advanced-data-binding)
      - [Exercise 17 Option Selector with Data-Binding Converters and Hooks](#exercise-17-option-selector-with-data-binding-converters-and-hooks)
      - [Exercise 18 Option Selector with Computed Data-Binding](#exercise-18-option-selector-with-computed-data-binding)
      - [Exercise 19 Address Form with Nested Indexed Data-Binding](#exercise-19-address-form-with-nested-indexed-data-binding)
    + [Section 5 Area (Canvas) Graphics](#section-5-area-canvas-graphics)
      - [Exercise 20 Area Shapes (Individual)](#exercise-20-area-shapes-individual)
      - [Exercise 21 Area Shapes](#exercise-21-area-shapes)
      - [Exercise 22 Area Shapes with Selection and Movement](#exercise-22-area-shapes-with-selection-and-movement)
    + [Section 6 Drag & Drop](#section-6-drag--drop)
      - [Exercise 23 Shape Coloring](#exercise-23-shape-coloring)
    + [Section 7 Custom Components](#section-7-custom-components)
      - [Exercise 24 Address Form Custom Control](#exercise-24-address-form-custom-control)
      - [Exercise 25 User Manager](#exercise-25-user-manager)
      - [Exercise 26 Basic Custom Shape](#exercise-26-basic-custom-shape)
    + [Section 8 Application Scaffolding](#section-8-application-scaffolding)
      - [Exercise 27 Application Scaffolding](#exercise-27-application-scaffolding)
  * [License](#license)
